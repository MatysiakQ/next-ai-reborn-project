...
const translations = {
  pl: {
    ...
    // Home page
    'home.benefits.badge': 'KORZYŚCI AUTOMATYZACJI',
    'home.benefits.heading.strong': 'ZWIĘKSZ',
    'home.benefits.heading.rest': 'EFEKTYWNOŚĆ',
    'home.benefits.line1': '> AI pracuje 24/7 dla Twojego biznesu',
    'home.benefits.line2': '> Automatyczne optymalizacje i analityka',
    'home.benefits.line3': '> Średni wzrost przychodów o 300%',
    'home.benefit.time.title': 'Oszczędność Czasu',
    'home.benefit.time.desc': '80% mniej czasu na powtarzalne zadania',
    'home.benefit.time.stat': '80%',
    'home.benefit.cost.title': 'Redukcja Kosztów',
    'home.benefit.cost.desc': 'Zmniejsz koszty operacyjne o 60%',
    'home.benefit.cost.stat': '60%',
    'home.benefit.sales.title': 'Wzrost Sprzedaży',
    'home.benefit.sales.desc': 'Średni wzrost konwersji o 250%',
    'home.benefit.sales.stat': '250%',
    'home.benefit.security.title': 'Bezpieczeństwo',
    'home.benefit.security.desc': '99.9% redukcji błędów ludzkich',
    'home.benefit.security.stat': '99.9%',

    'home.types.badge': 'TYPY AUTOMATYZACJI',
    'home.types.heading.strong': 'NASZE',
    'home.types.heading.rest': 'ROZWIĄZANIA',
    'home.types.desc1': '> Kompleksowe boty AI dla każdego biznesu',
    'home.types.desc2': '> Dostosowane do Twojej branży',
    'home.types.sales.title': 'Automatyzacja Sprzedaży',
    'home.types.sales.desc': 'Kwalifikacja leadów, follow-up, integracja CRM',
    'home.types.sales.f1': 'Ocena leadów',
    'home.types.sales.f2': 'Auto follow-up',
    'home.types.sales.f3': 'Integracja CRM',
    'home.types.marketing.title': 'Marketing AI',
    'home.types.marketing.desc': 'Generowanie treści, optymalizacja reklam, analityka',
    'home.types.marketing.f1': 'Generowanie treści',
    'home.types.marketing.f2': 'Optymalizacja reklam',
    'home.types.marketing.f3': 'Analityka',
    'home.types.support.title': 'Wsparcie Klienta',
    'home.types.support.desc': 'Chatboty 24/7, routing zgłoszeń, analiza sentymentu',
    'home.types.support.f1': 'Chatbot 24/7',
    'home.types.support.f2': 'Auto routing',
    'home.types.support.f3': 'Analiza sentymentu',
    'home.types.data.title': 'Przetwarzanie Danych',
    'home.types.data.desc': 'Procesy ETL, raportowanie, analiza danych',
    'home.types.data.f1': 'Procesy ETL',
    'home.types.data.f2': 'Auto raporty',
    'home.types.data.f3': 'Analiza danych',
    'home.types.workflow.title': 'Automatyzacja Workflow',
    'home.types.workflow.desc': 'Optymalizacja procesów, przydzielanie zadań, zatwierdzenia',
    'home.types.workflow.f1': 'Optymalizacja procesów',
    'home.types.workflow.f2': 'Przydzielanie zadań',
    'home.types.workflow.f3': 'Zatwierdzenia',
    'home.types.ecommerce.title': 'E-commerce AI',
    'home.types.ecommerce.desc': 'Rekomendacje produktów, magazyn, ceny',
    'home.types.ecommerce.f1': 'Rekomendacje produktów',
    'home.types.ecommerce.f2': 'Zarządzanie magazynem',
    'home.types.ecommerce.f3': 'Wycena',

    'home.stats.automatedFirms': 'Zautomatyzowane Firmy',
    'home.stats.uptime': 'Czas Pracy Botów',
    'home.stats.types': 'Typy Automatyzacji',
    'home.stats.support': 'Wsparcie Techniczne',

    'home.pricing.badge': 'PAKIETY AUTOMATYZACJI',
    'home.pricing.heading.strong': 'WYBIERZ',
    'home.pricing.heading.rest': 'SWÓJ PLAN',
    'home.pricing.line1': '> Różne poziomy automatyzacji dla Twojego biznesu',
    'home.pricing.line2': '> Skalowalne rozwiązania AI',
    'home.pricing.line3': '> Pełne wsparcie i optymalizacje',

    'home.contact.badge': 'SKONTAKTUJ SIĘ Z NAMI',
    'home.contact.heading.strong': 'DARMOWA',
    'home.contact.heading.rest': 'KONSULTACJA',
    'home.contact.line1': '> Omów swoje potrzeby automatyzacji z ekspertami',
    'home.contact.line2': '> Otrzymaj spersonalizowaną strategię AI',
    'home.contact.form.title': '> ZAPYTANIE_AUTOMATYZACJA.EXE',
    'home.contact.form.desc': 'Wypełnij formularz aby otrzymać darmową konsultację',
    'home.contact.form.name': 'FIRMA/IMIĘ:',
    'home.contact.form.namePlaceholder': 'Wprowadź nazwę firmy lub swoje imię...',
    'home.contact.form.email': 'EMAIL_KONTAKTOWY:',
    'home.contact.form.emailPlaceholder': 'kontakt@firma.pl',
    'home.contact.form.message': 'OPIS_POTRZEB:',
    'home.contact.form.messagePlaceholder': 'Opisz jakie procesy chcesz zautomatyzować...',
    'home.contact.form.submit': 'WYŚLIJ_ZAPYTANIE()',

    'home.footer.heading.strong': 'GOTOWY NA',
    'home.footer.heading.rest': 'AUTOMATYZACJĘ?',
    'home.footer.line1': '> Dołącz do firm, które już zautomatyzowały swoje procesy',
    'home.footer.line2': '> Rozpocznij swoją cyfrową transformację już dziś',
    'home.footer.viewCourses': 'ZOBACZ KURSY',

    // Automations page
    'automations.hero.badge': 'ROZWIĄZANIA AI AUTOMATYZACJI',
    'automations.hero.title': 'Zautomatyzuj Swój Biznes z AI',
    'automations.hero.desc': 'Odkryj moc inteligentnej automatyzacji. Nasze boty AI pracują 24/7, optymalizując procesy, zwiększając sprzedaż i redukując koszty operacyjne.',
    'automations.hero.freeConsultation': 'Darmowa Konsultacja',

    'automations.benefits.heading': 'Dlaczego Automatyzacja z NextAI?',
    'automations.benefits.time.title': 'Oszczędność Czasu',
    'automations.benefits.time.desc': 'Automatyzacja oszczędza do 80% czasu na powtarzalnych zadaniach',
    'automations.benefits.cost.title': 'Redukcja Kosztów',
    'automations.benefits.cost.desc': 'Zmniejsz koszty operacyjne dzięki automatyzacji procesów',
    'automations.benefits.performance.title': 'Wzrost Wydajności',
    'automations.benefits.performance.desc': 'Zwiększ produktywność zespołu o 300% dzięki AI',
    'automations.benefits.security.title': 'Bezpieczeństwo',
    'automations.benefits.security.desc': 'Minimalizuj ryzyko błędu ludzkiego w krytycznych procesach',

    'automations.categories.heading': 'Nasze Rozwiązania Automatyzacji',
    'automations.categories.subheading': 'Kompleksowe boty AI dla każdego aspektu Twojego biznesu',

    'automations.category.sales.title': 'Automatyzacja Sprzedaży',
    'automations.category.sales.desc': 'Zautomatyzuj proces sprzedaży od leada do konwersji',
    'automations.bots.leadQualifier.name': 'Bot Kwalifikacji Leadów',
    'automations.bots.leadQualifier.desc': 'Automatycznie kwalifikuje leady i przypisuje oceny jakości',
    'automations.bots.leadQualifier.features.1': 'Ocena leadów',
    'automations.bots.leadQualifier.features.2': 'Automatyczna segmentacja',
    'automations.bots.leadQualifier.features.3': 'Integracja CRM',
    'automations.bots.followUp.name': 'Automatyzacja Follow-up',
    'automations.bots.followUp.desc': 'Automatyczne follow-upy z potencjalnymi klientami',
    'automations.bots.followUp.features.1': 'Spersonalizowane wiadomości',
    'automations.bots.followUp.features.2': 'Optymalny timing',
    'automations.bots.followUp.features.3': 'Testy A/B',

    'automations.category.marketing.title': 'Automatyzacja Marketingu',
    'automations.category.marketing.desc': 'Optymalizuj kampanie marketingowe z AI',
    'automations.bots.contentGenerator.name': 'Bot Generowania Treści',
    'automations.bots.contentGenerator.desc': 'Generuje treści marketingowe dopasowane do Twojej marki',
    'automations.bots.contentGenerator.features.1': 'Posty w mediach społecznościowych',
    'automations.bots.contentGenerator.features.2': 'Treści blogowe',
    'automations.bots.contentGenerator.features.3': 'Kampanie emailowe',
    'automations.bots.adOptimizer.name': 'Bot Optymalizacji Reklam',
    'automations.bots.adOptimizer.desc': 'Optymalizuje reklamy w czasie rzeczywistym',
    'automations.bots.adOptimizer.features.1': 'Optymalizacja budżetu',
    'automations.bots.adOptimizer.features.2': 'Targetowanie odbiorców',
    'automations.bots.adOptimizer.features.3': 'Śledzenie ROI',

    'automations.category.support.title': 'Automatyzacja Wsparcia Klienta',
    'automations.category.support.desc': 'Wsparcie klienta 24/7 z chatbotami AI',
    'automations.bots.support.name': 'Bot Wsparcia Klienta',
    'automations.bots.support.desc': 'Inteligentny chatbot obsługujący zapytania klientów',
    'automations.bots.support.features.1': 'Natural Language Processing',
    'automations.bots.support.features.2': 'Integracja z bazą wiedzy',
    'automations.bots.support.features.3': 'Przekazanie do człowieka',
    'automations.bots.feedback.name': 'Bot Zbierania Feedbacku',
    'automations.bots.feedback.desc': 'Automatycznie zbiera i analizuje feedback klientów',
    'automations.bots.feedback.features.1': 'Analiza sentymentu',
    'automations.bots.feedback.features.2': 'Kategoryzacja feedbacku',
    'automations.bots.feedback.features.3': 'Raporty insights',

    'automations.category.process.title': 'Automatyzacja Procesów',
    'automations.category.process.desc': 'Zautomatyzuj powtarzalne zadania biznesowe',
    'automations.bots.dataProcessing.name': 'Bot Przetwarzania Danych',
    'automations.bots.dataProcessing.desc': 'Automatyczne przetwarzanie i analiza danych',
    'automations.bots.dataProcessing.features.1': 'Procesy ETL',
    'automations.bots.dataProcessing.features.2': 'Raportowanie',
    'automations.bots.dataProcessing.features.3': 'Integracje API',
    'automations.bots.workflow.name': 'Bot Automatyzacji Workflow',
    'automations.bots.workflow.desc': 'Automatyzuje złożone procesy biznesowe',
    'automations.bots.workflow.features.1': 'Workflow zatwierdzeń',
    'automations.bots.workflow.features.2': 'Przydzielanie zadań',
    'automations.bots.workflow.features.3': 'Śledzenie postępu',

    'automations.bot.featuresLabel': 'Kluczowe funkcje:',

    'automations.industries.heading': 'Branże Które Obsługujemy',
    'automations.industries.subheading': 'Nasze rozwiązania AI działają w każdej branży',
    'automations.industries.ecommerce': 'E-commerce',
    'automations.industries.fintech': 'Fintech',
    'automations.industries.healthcare': 'Ochrona Zdrowia',
    'automations.industries.realestate': 'Nieruchomości',
    'automations.industries.saas': 'SaaS',
    'automations.industries.manufacturing': 'Produkcja',

    'automations.cta.heading': 'Gotowy na Automatyzację?',
